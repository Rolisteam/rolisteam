...
QVariant CharacterSheetButton::getValue(Item::ColumnId id) const
{
    switch(id)
    {
    case NAME:
...
void CharacterSheetButton::setValue(Item::ColumnId id, QVariant var)
{
    switch(id)
    {
    case NAME:
...
void CharacterSheetButton::generateQML(QTextStream &out,Item::QMLSection sec)
{
