...
namespace GMTOOL
{
    QHash<Unit::Category, QString> UnitModel::m_cat2Text({{Unit::CURRENCY, QObject::tr("Currency")},
        {Unit::DISTANCE, QObject::tr("Distance")}, {Unit::TEMPERATURE, QObject::tr("Temperature")},
        {Unit::MASS, QObject::tr("MASS")}, {Unit::MASS, QObject::tr("OTHER")}});
    ...
    QString CategoryModel::currentCategory() const { return m_currentCategory; }
    ...
    //////////////////////
    UnitModel::UnitModel(QObject* parent) : QAbstractListModel(parent) { readSettings(); }

    Unit* UnitModel::indexToUnit(const QModelIndex& index) const { return getUnitByIndex(index.row()); }
    ...
    QHash<Unit::Category, QString> UnitModel::cat2Text() const { return m_cat2Text; }

    void UnitModel::setCat2Text(const QHash<Unit::Category, QString>& cat2Text) { m_cat2Text= cat2Text; }

    QString UnitModel::getCatNameFromId(Unit::Category id) const { return m_cat2Text[id]; }
