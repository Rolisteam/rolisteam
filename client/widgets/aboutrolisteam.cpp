    ...
    ui(new Ui::AboutRolisteam)
{
    ...
    table+=line.arg("Lorram Lomeu de Souza Rampi", tr("Portuguese"), "https://www.transifex.com/accounts/profile/lorrampi/");
    table+=line.arg("Juliana Alves de Sousa Rampi", tr("Portuguese"), "https://www.transifex.com/accounts/profile/JuAlves/");
