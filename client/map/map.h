...
private:
    ...
    QPoint m_distanceBetweenMouseAndNPC; // difference entre le coin sup gauche du PNJ selectionne (pnjSelectionne) et
                                         // la position de la souris au moment du clic
    ...
    QRect m_penGlobalZone;         // unite de toutes les zone a raffraichir lors du trace du crayon (emise aux autres
                                   // utilisateurs)
    ...
    QList<QPoint>
        m_penPointList; // liste des points composant le trace du crayon, qui sera emise aux autres utilisateurs
