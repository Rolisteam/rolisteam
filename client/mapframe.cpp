...
void MapFrame::initMap()
{
    if(nullptr != m_map)
    {
        ...
        connect(m_map, SIGNAL(commencerDeplacementBipMapWindow(QPoint)), this, SLOT(startMoving(QPoint)));
        connect(m_map, SIGNAL(deplacerBipMapWindow(QPoint)), this, SLOT(moveMap(QPoint)));
