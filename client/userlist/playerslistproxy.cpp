    ...
    : QAbstractProxyModel(parent), m_rowsAboutToBeInserted(false), m_rowsAboutToBeRemoved(false)
{
    ...
    connect(g_playersList, SIGNAL(rowsAboutToBeInserted(QModelIndex, int, int)), this,
        SLOT(p_rowsAboutToBeInserted(QModelIndex, int, int)));
    connect(g_playersList, SIGNAL(rowsInserted(QModelIndex, int, int)), this, SLOT(p_rowsInserted()));
    connect(g_playersList, SIGNAL(rowsAboutToBeRemoved(QModelIndex, int, int)), this,
        SLOT(p_rowsAboutToBeRemoved(QModelIndex, int, int)));
    connect(g_playersList, SIGNAL(rowsRemoved(QModelIndex, int, int)), this, SLOT(p_rowsRemoved()));
    connect(g_playersList, SIGNAL(dataChanged(QModelIndex, QModelIndex)), this,
        SLOT(p_dataChanged(QModelIndex, QModelIndex)));
}
