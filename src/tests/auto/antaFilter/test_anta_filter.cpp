...
{
    //name, path, descr, color, distanceperturn, hp, initVal, lifeColor, minhp, maxhp, size, state Id, tags, id, hasAct, hasProp, hasShape
    std::vector<std::tuple<QString, QString, QString, QColor,int, int, int, QColor, int, int, int, QString, QStringList, QString, bool, bool, bool, QString, QString>> data{
        {"Lynn Gray-Rike","","blond with a gun", QColor(Qt::blue), 0, 100, 0, QColor(Qt::green), 0, 100, 64, "safe", {"cops", "girl", "swat", "law"}, "lynn", true, true, true, "" ,""},
        {"Otomo Akamu","","Ikoma's shadow", QColor(Qt::darkGreen), 0, 49, 10, QColor(Qt::green), 0, 100, 64, "injured", {"l5r", "secret", "honor", "spouse"}, "akamu", false, false, false,"4G3", "gm details"},
        {"Ikoma Kae","","Proud with beautiful voice", QColor(Qt::darkYellow), 0, 100, 0, QColor(Qt::green), 0, 100, 64, "safe", {"l5r", "singer", "general", "lion"}, "kae", true, false, false, "1d10+10", "daughter of the bad guy"},
        {"Toku Kahime","","The young prodigy", QColor(Qt::darkRed), 0, 12, 35, QColor(Qt::green), 0, 100, 64, "heavily injured", {"l5r", "champion", "monkey", "samurai"}, "kahime", true, true, false, "", "Afraid of hawks"},
        {"John Northa","","Long sword actor", QColor(Qt::cyan), 0, 100, 0, QColor(Qt::green), 0, 100, 64, "safe", {"mv", "angel", "sword", "faith"}, "john", true, false, true, "6d10", ""},
        {"Luna Gaztelumendi","","Demon with sniper rifle", QColor(Qt::darkMagenta), 0, 0, 0, QColor(Qt::green), 0, 100, 64, "dead", {"ins", "girl", "demon", "succube"}, "luna", false, true, true,"",""},
};
...
{
    m_sourceModel.reset(new campaign::NonPlayableCharacterModel());
...
void TestAntaFilter::advancedFilterModel_data()
{
    ...
    static QList<PropertyInfo> infos{
        {"search",
            {"","lynn","otomo","ikoma","john","kahime","luna","ka","zzz"},
            {6,1,1,1,1,1,1,3,0}
        },
        {"exclude",
        ...
        {"avatarDefinition",
            {campaign::FilteredCharacterModel::All, campaign::FilteredCharacterModel::With, campaign::FilteredCharacterModel::Without},
            {6,0,6}
        },
        {"initiativeScoreDef",
            {campaign::FilteredCharacterModel::All, campaign::FilteredCharacterModel::With, campaign::FilteredCharacterModel::Without},
