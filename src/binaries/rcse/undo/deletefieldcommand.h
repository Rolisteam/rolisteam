...
{
public:
    DeleteFieldCommand(FieldController* fields, Canvas* canvas, FieldModel* model, int currentPage,
                       QUndoCommand* parent= 0);
    DeleteFieldCommand(QList<CSItem*> fields, QList<Canvas*> canvas, FieldModel* model, QList<int> currentPage,
                       QUndoCommand* parent= 0);
