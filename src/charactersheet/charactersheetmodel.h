...
//    */
//    TreeItem(CharacterSheetItem* p,bool isLeaf);
    
//    /**
//    * @brief defines the stored section
//    */
//    void setCharacterSheetItem(CharacterSheetItem* p);
//    /**
//    * @brief accessor to the stored section
//    */
//    CharacterSheetItem* getCharacterSheetItem();
