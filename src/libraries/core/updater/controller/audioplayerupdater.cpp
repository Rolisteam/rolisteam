...
void AudioPlayerUpdater::initSignalForGM()
{
    ...
    connect(m_campaign, &campaign::CampaignManager::campaignLoaded, this, [ctrl1, ctrl2, ctrl3, this]() {
    ...
    // play/stop/pause
    connect(ctrl1, &AudioPlayerController::stateChanged, this, [](AudioPlayerController::State state) {
    ...
    connect(ctrl2, &AudioPlayerController::stateChanged, this, [](AudioPlayerController::State state) {
        auto netAction= state2Action(state);
