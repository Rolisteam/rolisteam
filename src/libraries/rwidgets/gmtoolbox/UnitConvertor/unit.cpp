...
namespace GMTOOL
{
    ...
    QString Unit::symbol() const { return m_symbol; }

    void Unit::setSymbol(const QString& symbol) { m_symbol= symbol; }
    QString Unit::name() const { return m_name; }

    void Unit::setName(const QString& name) { m_name= name; }
    Unit::Category Unit::currentCat() const { return m_currentCat; }

    void Unit::setCurrentCat(const Unit::Category& currentCat) { m_currentCat= currentCat; }

    bool Unit::readOnly() const { return m_readOnly; }

    void Unit::setReadOnly(bool readOnly) { m_readOnly= readOnly; }
