...
ColorSelector::ColorSelector(QWidget* parent) : QWidget(parent)
{
    ...
    int rouge[48]= {255, 255, 128, 0, 128, 0, 255, 255, 255, 255, 128, 0, 0, 0, 128, 255, 128, 255, 0, 0, 0, 128, 128,
        255, 128, 255, 0, 0, 0, 0, 128, 128, 64, 128, 0, 0, 0, 0, 64, 64, 0, 128, 128, 128, 64, 192, 64, 255};
    int vert[48]= {128, 255, 255, 255, 255, 128, 128, 128, 0, 255, 255, 255, 255, 128, 128, 0, 64, 128, 255, 128, 64,
        128, 0, 0, 0, 128, 128, 128, 0, 0, 0, 0, 0, 64, 64, 64, 0, 0, 0, 0, 0, 128, 128, 128, 128, 192, 64, 255};
    int bleu[48]= {128, 128, 128, 128, 255, 255, 192, 255, 0, 0, 0, 64, 255, 192, 192, 255, 64, 64, 0, 128, 128, 255,
        64, 128, 0, 0, 0, 64, 255, 160, 128, 255, 0, 0, 0, 64, 128, 64, 64, 128, 0, 0, 64, 128, 128, 192, 64, 255};
    ...
    for(i= 0, x= 0, y= 7; i < 16; i++)
    {
        ...
        QColorDialog::setCustomColor(
            i, m_preferences->value(QString("customcolors%1").arg(i), QColor(Qt::white)).value<QColor>().rgb());
    ...
    m_pixelErase= new QPixmap(":/resources/images/erase.png");
    ...
    m_maskPixel= new QPixmap(":/resources/images/hide.png");
    ...
    m_unveilPixel= new QPixmap(":/resources/images/showMap.png");
    ...
    else if(event->type() == QEvent::MouseButtonDblClick)
    {
        if(obj == m_currentColor)
        {
            ...
            if(couleur.isValid())
            {
                ...
                m_currentColor->setToolTip(
                    tr("Red: %1, Green: %2, Blue: %3").arg(couleur.red()).arg(couleur.green()).arg(couleur.blue()));
            }
        }
    }
...
void ColorSelector::changeCurrentColor(QColor color)
{
    ...
    m_currentColor->setToolTip(
        tr("Red: %1, Green: %2, Blue: %3").arg(color.red()).arg(color.green()).arg(color.blue()));
    s_selectedColor.type= ColorType;
