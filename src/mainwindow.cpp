...
void MainWindow::aboutRolisteam()
{
    QMessageBox::about(this, tr("About Rolisteam"),
                       ...
                       tr("<p><h3>Web Sites :</h3>"
                          ...
                          "<p><h3>Translators</h3>"
                          "<ul>"
                          "<li><a href=\"https://www.transifex.com/accounts/profile/Le_Sage/\">Renaud Guezennec<a/>(English & French)</li>"
                          "<li><a href=\"https://www.transifex.com/accounts/profile/lorrampi/\">Lorram Lomeu de Souza Rampi<a/>(Portuguese)</li>"
                          "<li><a href=\"https://www.transifex.com/accounts/profile/JuAlves/\">Juliana Alves de Sousa Rampi<a/>(Portuguese)</li>"
                          "<li><a href=\"https://www.transifex.com/accounts/profile/KrekoG/\">Gergely Kreko<a/>(Hungarian)</li>"
                          "<li><a href=\"https://www.transifex.com/accounts/profile/kayazeren/\">Kaya Zeren<a/>(Turkish)</li>"
                          "<li><a href=\"https://www.transifex.com/accounts/profile/IGrumoI/\">Alexia<a/>(French & German)</li>"
                          "</ul>"
