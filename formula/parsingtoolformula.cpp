...
namespace Formula
{
    ParsingToolFormula::ParsingToolFormula() : m_variableHash(nullptr)
    {
    ...
    QHash<QString, QString>* ParsingToolFormula::getVariableHash() const { return m_variableHash; }

    void ParsingToolFormula::setVariableHash(QHash<QString, QString>* variableHash) { m_variableHash= variableHash; }
