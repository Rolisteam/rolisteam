...
bool QmlGeneratorVisitor::generateTable(Field *item)
{
    ...
    "%1        acceptedButtons: contextMenu%3.visible ? Qt.LeftButton : Qt.RightButton\n"
    "%1        onClicked: {\n"
    "%1            mouse.accepted = false\n"
    "%1            if(mouse.button == Qt.RightButton)\n"
    "%1                contextMenu%3.popup()\n"
    "%1            if(mouse.button == Qt.LeftButton)\n"
    "%1                contextMenu%3.dismiss()\n"
    "%1        }\n"
    "%1        Menu {\n"
    "%1            id: contextMenu%3\n"
    "%1            MenuItem { \n"
